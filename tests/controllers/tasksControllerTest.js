      ...
      it('Should create task', function (done) {
        ...
        request(app)
          ...
          .then(function(res) {
            ...
            res.body.data[0].tasks[0].title.should.equal('task1');
            res.body.data[0].tasks[0].priority.should.equal('Medium');
            done();
          });
      });
    });
      ...
      it('Should create task', function (done) {
        ...
        request(app)
          ...
          .then(function(res) {
            res.status.should.be.equal(200);
            res.body.data[0]._id.should.equal(project1._id);
            res.body.data[0].tasks[0].title.should.equal('newTitle');
            res.body.data[0].tasks[0].status.should.equal(true);
            res.body.data[0].tasks[0].priority.should.equal('Low');
            done();
          });
      });
    });
    ...
    describe('Remove /tasks', function() {
      it('Should remove task', function (done) {
        ...
        request(app)
          ...
          .then(function(res) {
            res.status.should.be.equal(200);
            res.body.data[0].tasks.length.should.be.equal(0);
            done();
          });
      });
    });
